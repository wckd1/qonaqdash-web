...
export function usePermissions() {
  ...
  return {
    ...
    canAccessHousekeepingTasks: computed(() => canAccessHousekeepingTasks(ctx.value)),
    canCreateHousekeepingTasks: computed(() => canCreateHousekeepingTasks(ctx.value)),
    canOperateHousekeepingTasks: computed(() => canOperateHousekeepingTasks(ctx.value)),
    canAssignHousekeepingTasks: computed(() => canAssignHousekeepingTasks(ctx.value)),
    canAccessMaintenanceTasks: computed(() => canAccessMaintenanceTasks(ctx.value)),
    canCreateMaintenanceTasks: computed(() => canCreateMaintenanceTasks(ctx.value)),
    canOperateMaintenanceTasks: computed(() => canOperateMaintenanceTasks(ctx.value)),
    canAssignMaintenanceTasks: computed(() => canAssignMaintenanceTasks(ctx.value)),
  }
}
